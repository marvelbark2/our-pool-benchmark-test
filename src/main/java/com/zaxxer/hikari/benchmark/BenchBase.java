...
import com.zaxxer.hikari.benchmark.pool.BlockingPool;
import com.zaxxer.hikari.benchmark.pool.PoolDataSource;
import com.zaxxer.hikari.benchmark.pool.PoolFactory;
...
public class BenchBase {
    ...
    public void setup(BenchmarkParams params) {
        ...
        if (this.getClass().getName().contains("Statement")) {
            System.err.println(
                    "# Overriding maxPoolSize paramter for StatementBench: maxPoolSize=" + params.getThreads());
    ...
    protected void setupSmartBuildings() {
        DS = new PoolDataSource();
    }
